...
namespace MvvmCross.Plugin.QrCode.Android
{
    ...
    public class MvxQrCode : BaseMvxQrCode
    {
        ...
        private CameraResolution ResolutionSelector(List<CameraResolution> availableResolutions)
        {
            ...
            var displayOrientationHeight = currentActivity.Resources.Configuration.Orientation == Orientation.Portrait ? (double)height : (double)width;
            var displayOrientationWidth = currentActivity.Resources.Configuration.Orientation == Orientation.Portrait ? (double)width : (double)height;
